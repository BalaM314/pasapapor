...
//Data
const otherDocuments = (d => Object.fromEntries(d.map(([url, name]) => (Array.isArray(name) ? name : [name])
    .map(name => [name, { url: () => url }])).flat(1)))([
